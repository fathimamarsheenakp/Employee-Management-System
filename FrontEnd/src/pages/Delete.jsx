...
export default function Delete() {
  ...
  const handleDelete = () => {
    ...
    fetch(`http://localhost:9090/api/employee/delete/${employee.id}`, {
        method: 'DELETE',
    })
    .then((response) => {
        if (!response.ok) {
        ...
        return response.text(); // Since the backend sends a string response
    })
    .then((data) => {
    ...
    <div className='home-container'>
      ...
      <main className="main-content">
        <section className='welcome-section'>
          ...
          {/* Display Edit Button if Employee is Found */}
          {employee && (
